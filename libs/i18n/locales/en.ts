...
export const en: Locale = {
  ...
  ai: {
    ...
    bodyModel: {
      title: "3D Body Model (MVP)",
      subtitle: "Enter measurements in centimeters, rotate the preview, and save a screenshot.",
      viewer: {
        title: "Preview",
        helper: "Drag to rotate • Scroll to zoom",
      },
      controls: {
        title: "Measurements (cm)",
        helper: "Numbers are clamped to safe ranges to reduce distortion.",
        genderLabel: "Gender",
        female: "Female",
        male: "Male",
        heightCm: "Height",
      ...
      disclaimer: {
        title: "MVP notice",
        body: "This is a procedural mannequin for validation. Replace it with your licensed GLB models (male/female) with morph targets/rig for production.",
      },
    },
    nanoBanana: {
